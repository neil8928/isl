...
class NotificacionTamizajeFinalDiaBellavista extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'notificacion:tamizajefinalbellavista';
    /**
    ...
    public function handle()
    {
        ...
        $email              =   WEBMaestro::where('codigoatributo','=','0001')->where('codigoestado','=','00007')->first();
        ...
        file_get_contents('http://10.1.50.2:8080/isl/tamizaje-del-dia-bellavista');
