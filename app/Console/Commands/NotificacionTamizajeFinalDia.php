...
class NotificacionTamizajeFinalDia extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'notificacion:tamizajefinal';
    /**
    ...
    public function handle()
    {
        ...
        file_get_contents('http://10.1.50.2:8080/isl/tamizaje-del-dia');
