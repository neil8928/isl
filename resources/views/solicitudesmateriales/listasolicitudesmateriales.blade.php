          ...
          <div class="row">
            <div class="col-sm-12 col-mobil">
              <div class="panel panel-default panel-table">
                <div class="panel-heading">Lista Solicitudes de Materiales
                  <div class="tools tooltiptop">

                    <a href="#" class="tooltipcss opciones" id='buscarsolicitudesmateriales'>
                      <span class="tooltiptext">Buscar Solicitudes</span>
                ...
                <div class="col-sm-12">
                  <div class="panel panel-default">
                    <div class='listatablasolicitudes listajax'>
                      @include('solicitudesmateriales.ajax.listasolicitudesmateriales')
                    </div>
                  </div>
                </div>
...
@section('script')
  ...
  <script src="{{ asset('public/js/logistica/solicitudmaterial.js?v='.$version) }}" type="text/javascript"></script>
