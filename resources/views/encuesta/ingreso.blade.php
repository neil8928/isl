        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="panel panel-default panel-border-color panel-border-color-primary">
              ...
              <span class="splash-description">Por favor ingrese su dni.</span>
              </div>
              <div class="panel-body">
                ...
                <form method="POST" action="{{ url('encuesta') }}">
                  ...
                  <div class="form-group login-submit">
                    <button data-dismiss="modal" type="submit"  class="btn btn-primary btn-xl">Iniciar</button>
                  </div>
                  ...
                  <div class="form-group login-submit" style="padding-top:0px">
                    <button data-dismiss="modal" type="submit"  class="btn btn-primary btn-xl btn_rn">Ver revista virtual</button>
                  </div>
