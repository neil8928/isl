          ...
          <div class="row">
            <div class="col-sm-12 col-mobil">
              <div class="panel panel-default panel-table">
                <div class="panel-heading">Lista Orden Compra Servicios
                  <div class="tools tooltiptop">

                    <a href="#" class="tooltipcss opciones" id='buscarordencompraservicio'>
                      <span class="tooltiptext">Buscar orden compra servicio</span>
                ...
                <div class="col-sm-12">
                  <div class="panel panel-default">
                    <div class='listajax'>
                      @include('ordencompra.ajax.alistaservicios')
                    </div>
                  </div>
                </div>
